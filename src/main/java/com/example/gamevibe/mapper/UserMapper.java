...
public interface UserMapper extends BaseMapper<User> {
    ...
    @Select("SELECT u.id, u.user_id, u.nick_name, u.avatar, u.create_time, u.ip_addr, u.intro, fu.focus_count, fu.fans_count, pl.like_count + pc.collect_count AS like_collect_count " +
    ...
    @Insert("INSERT IGNORE INTO user (user_id, avatar) VALUES (#{user_id}, #{avatar})")
    void register(String user_id, String avatar);
